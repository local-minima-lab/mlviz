import Display from "@/components/decision_tree/classifier/prediction/Display";
...
const Feature: React.FC<FeatureProps> = ({ presetPoints }) => {
    ...
    const [trainingParams, setTrainingParams] =
        useState<TrainingParameters>(lastTrainedParams);

    useEffect(() => {
        setTrainingParams(lastTrainedParams);
    }, [lastTrainedParams]);
